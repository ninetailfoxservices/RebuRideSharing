...
void existingDriver(fstream& driverReg, fstream& bookingInfo);
...
void driverMenu(fstream& driverReg, fstream& bookingInfo);
...
void availableTrips(fstream& driverReg, fstream& bookingInfo);
//void viewPayment();
//void cancelTrip();
 ...
 //   Booking Book;
    ...
    while (true)
    {
        ...
        case 1:
            ...
            break;
        case 2:
            existingDriver(driverReg, bookingInfo);
            break;
        case 3:
...
void existingDriver(fstream& driverReg, fstream& bookingInfo)
{
    ...
    while (accountFound == false)
    {
        ...
        {
            driverMenu(driverReg, bookingInfo);
        }
        else {
            attempt--;
...
void driverMenu(fstream& driverReg, fstream& bookingInfo)
{
    ...
    while (true)
    {
        ...
        case 2:
            driverReg.close();
            availableTrips(driverReg, bookingInfo);
        case 3:
            //   viewPayment();
            break;
        case 4:
...
void bookingTrip(fstream& bookingInfo, fstream& customerReg)
{
    ...
    *BK.bookingDateTime = {};
    ...
    printLine();
    cout << "\n\tTrip Details\n";
    cout << "Trip Availability : " << BK.availability << endl;
    cout << "\nDate and Time : " << BK.bookingDateTime;
...
void availableTrips(fstream& driverReg, fstream& bookingInfo)
{
    ...
    int choice = 0;//use to choose which trip they want to accept
    ...
    driverReg.open("driverReg.dat", ios::out | ios::binary);
    if (!driverReg)
    {
    ...
    cout << "Choose Which trip you want to accept : ";
    while (true)
    {
        cin >> choice;
        if (!cin)
        {
            cout << "\n[Please enter an interger for Trip Selection]" << endl;
            cout << "Choose Which trip you want to accept : ";
            cin.clear();
            cin.ignore(numeric_limits<streamsize>::max(), '\n');
            continue;
    ...
    bookingInfo.open("bookingInfo.dat", ios::out | ios::binary);
    if (!bookingInfo)
    {
        cout << "Error, file Booking not found.";
        exit(1);
